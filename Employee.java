class EmpDetails {
    ...
    public EmpDetails(int emp_id, int salary, String name, String department, String email, String designation) {
        this.emp_id = emp_id;
        this.salary = salary;
        this.name = name;
...
public class Employee {
    public static void main(String[] args) {
        EmpDetails emp = new EmpDetails(111, 100000, "Kiran Rao", "IT", "kiran567@gmail.com", "Head");
